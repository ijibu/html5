...
<html>
	...
	<body style="overflow-y: scroll; overflow-x: hidden; background-color: rgb(133, 89, 38); background-image: url(./images/light-yellow.jpg);">
		...
		<div id="community">
			<div id="community-menu" class="black-box">
				...
				<ul class="categories">
					...
					<li>
						<a href="http://websnooker.com/index.php?id=6bc884-f18bfd-605137&host=1#news">
							News
						</a>
					</li>
					<li>
					...
					<li>
						<a href="http://websnooker.com/index.php?id=6bc884-f18bfd-605137&host=1#welcome-screen">
							About
						</a>
					</li>
					<li>
						<a href="http://websnooker.com/index.php?id=6bc884-f18bfd-605137&host=1#credits">
							Credits
						</a>
					</li>
				</ul>
			...
			<div class="wrapper topmost" style="display: none;">
				<div id="welcome-screen" class="black-box">
					...
					<p>
						...
						anytime in the settings by pressing [
						<strong>
							S
						</strong>
						] key.
					...
					<ul>
						<li>
							...
							<p>
								...
								game on the
								<a href="http://gaming.mozillalabs.com/">
									Game On
								</a>
		...
		<div id="game-container">
			<div id="pool">
				<canvas width="1067" height="600" id="screen">
				</canvas>
			</div>
			...
			<div id="power-bar-wrapper">
				<div id="power-bar">
					<div id="power-meter" style="height: 377px;">
					</div>
				</div>
			</div>
			<!-- #power-bar - end -->
							...
							<table>
								<tbody>
									<tr>
										...
										<td>
											<input type="text" name="server_name" value="Snooker server">
										</td>
									</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
											<select name="gamemode">
												...
												<option value="short-snooker">
													Short Snooker
												</option>
												<option value="mini-snooker">
													Mini Snooker
												</option>
											</select>
										</td>
							...
							<table>
								<tbody>
									<tr>
										...
										<td>
											<input type="password" name="client_password" value="">
										</td>
									</tr>
								</tbody>
							</table>
					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td>
									<label>
										<input type="radio" name="scoreboard-position" value="top">
										Top
									</label>
									<label>
										<input type="radio" name="scoreboard-position" value="bottom">
										Bottom
									</label>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="checkbox" name="shadows">
								</td>
							</tr>
							<tr>
								<th>
				...
				<div id="browser-detect" class="black-box">
					...
					<ul>
						...
						<li>
							...
							<strong>
								4 beta recommended where possible
							</strong>
							)
						</li>
						<li>
				...
				<div class="common-popup black-box invitation">
					...
					<div class="container">
						<p>
							...
							to a match (
							<span>
								Game mode: Full snooker, Frames: 3, Shot time: unlimited
							</span>
							)
						</p>
					</div>
		...
		<div style="position: absolute; top: 50%; left: 50%;">
			...
			id="myotziv_box">
				<div class="widsnjx">
					<div id="poxupih">
						<div class="poxupih_top">
						</div>
						<div class="poxupih_center">
							<div class="poxupih1">
								<div class="gertuik">
									<a class="pokusijy" onclick="MyOtziv.mo_hide_box();">
									</a>
									<div class="fdsrrel">
