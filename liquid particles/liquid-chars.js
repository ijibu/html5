var canvas, ctx, canvContainer, outerDiv, canvasW = 1E3, canvasH = 560, friction = 0.96, numMovers = 180, movers = [], isMouseDown = false, mouseX = 0, mouseY = 0, mouseVX = 0, mouseVY = 0, prevMouseX = 0, prevMouseY = 0, quartCirc = Math.PI * 0.5;
function init() {
	canvas = document.getElementById("mainCanvas");
	if (canvas.getContext) {
		setup();
		setInterval(run, 33);
		trace('interact with the mouse, occasionally click or hold down the mousebutton<br /><a href="/lab">spielzeugz.de/lab</a>')
	} else
		trace("Sorry, needs the latest version of Firefox, Chrome, Safari or Opera.")
}
function setup() {
